...
awsClient.putObject("gdelt-tdenimal", "201801.export.CSV.zip", new File( "/data/spark/201801.export.CSV.zip") )
awsClient.putObject("gdelt-tdenimal", "201801.mentions.CSV.zip", new File( "/data/spark/201801.mentions.CSV.zip") )
awsClient.putObject("gdelt-tdenimal", "201801.translation.export.CSV.zip", new File( "/data/spark/201801.translation.export.CSV.zip") )
...
val sampleDF = filesDF.filter(col("url").contains("/20181201110000.mentions")).cache
