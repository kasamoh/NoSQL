...
//Load events
val events = sqlContext.read.parquet("s3a://gdelt-tdenimal/201809.events")
...
val translations_events = sqlContext.read.parquet("s3a://gdelt-tdenimal/201809.translation.events")
...
//Load mentions
val mentions = sqlContext.read.parquet("s3a://gdelt-tdenimal/201809.mentions")
...
val translation_mentions_old = sqlContext.read.parquet("s3a://gdelt-tdenimal/201809.translation.mentions")
...
MongoSpark.save(total_mentions_events.write.option("spark.mongodb.output.uri", "mongodb://master:27020/tdenimal.mentions_events").mode("append"))
