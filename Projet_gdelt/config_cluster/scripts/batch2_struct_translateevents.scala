...
val textRDD = sc.binaryFiles("s3a://gdelt-tdenimal/201812.translation.export.CSV.zip"). // charger quelques fichers via une regex
...
dataFrame.write.format("parquet").mode("overwrite").save("s3a://gdelt-tdenimal/201812.translation.events")
