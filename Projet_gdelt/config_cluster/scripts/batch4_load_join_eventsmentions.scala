...
//Load events
val events = sqlContext.read.parquet("s3a://gdelt-tdenimal/201801.events")
...
val translations_events = sqlContext.read.parquet("s3a://gdelt-tdenimal/201801.translation.events")
...
//Load mentions
val mentions = sqlContext.read.parquet("s3a://gdelt-tdenimal/201801.mentions")
...
val translation_mentions_old = sqlContext.read.parquet("s3a://gdelt-tdenimal/201801.translation.mentions")
...
val total_mentions_events=total_mentions_clean.join(total_events_clean,total_mentions_clean.col("EventId")===total_events.col("EventId"),"left")

MongoSpark.save(total_mentions_events.write.option("spark.mongodb.output.uri", "mongodb://master:27017/tdenimal.mentions_events").mode("append"))
